...
//!
//!   * a corpus module proto 15 "GetPlaceableCanvases": pc4 `JUMPIFNOT R0`,
...
//!
//!   * another corpus module proto 10 "CheckIfSetIsReadyToCollect": same shape with
...
/// First-exhibit shape: JUMPIFNOT entry, fallthrough arm `MOVE R2 = R0`,
...
/// Inverted polarity: JUMPIF entry, fallthrough arm `LOADNIL R2`, jump arm
