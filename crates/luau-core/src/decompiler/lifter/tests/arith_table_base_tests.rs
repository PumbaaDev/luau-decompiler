...
//!
//! Round-3 census of the 111 corpus defects: 86 READONLY chunk-top hoists, 46
...
//!
//!   * a corpus module proto 13 "updateDrag": pc31 `SUB R2 = R1 - R3`
//!     (Vector2 - Vector2, the drag delta), pcs 39/47 `GETTABLEKS R6 =
//!     R2["X"/"Y"]` — the bytecode indexes the SUB result directly.
//!   * another corpus module proto 1 "createTriangle": pc21 `SUB R26 = R0 - R1`,
