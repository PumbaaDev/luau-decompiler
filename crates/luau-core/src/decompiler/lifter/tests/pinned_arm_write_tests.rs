...
//! this umbrella). Bytecode exhibit (a corpus module),
...
//! bails when either arm emits ANY statement, which is exactly the census-exhibit
...
/// (the write under test). R1 is read after the join. This is the census
/// exhibit child in miniature.
///
/// ```text
