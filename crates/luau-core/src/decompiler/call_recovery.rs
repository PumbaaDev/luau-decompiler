...
//! on the measured corpus: 8 protos emit ZERO calls where the bytecode has
//! three or more (one corpus proto loses 20,
...
thread_local! {
    ...
    ///
    /// A proto can be lifted MORE THAN ONCE - a corpus module lifts proto
...
/// small shortfalls in large functions, e.g. a corpus module (`Update`)
